...
function _normality_boundary_required_phrases()
    return [
        ...
        "The final ordinary-polynomial Park-Woodburn public contract (#187) is supported for exact field-backed ordinary-polynomial determinant-one `SL_3` and exact field-backed ordinary-polynomial determinant-one `SL_n`, `n > 3`, inputs through the implemented evidence-backed route",
        "Staged ordinary-polynomial inputs include determinant-one matrices missing the required local-form, variable-change, normality/conjugation, Murthy, Quillen, ECP, or final `SL_3` evidence path",
